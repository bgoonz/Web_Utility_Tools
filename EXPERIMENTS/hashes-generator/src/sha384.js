  ...
  CryptoJS || ((a, c) => {
    const d = {},
          ...
          B = (j.WordArray = m.extend({
            ...
            concat(a) {
              const b = this.words, g = a.words, e = this.sigBytes;
              a = a.sigBytes;
              this.clamp();
              if (e % 4)
                for (var k = 0; k < a; k++)
          ...
          y = (v.Hex = {
            ...
            parse(a) {
              for (var b = a.length, g = [], e = 0; e < b; e += 2)
                g[e >>> 3] |= parseInt(a.substr(e, 2), 16) << (24 - 4 * (e % 8));
          ...
          F = (v.Latin1 = {
            ...
            parse(a) {
              for (var b = a.length, g = [], e = 0; e < b; e++)
                g[e >>> 2] |= (a.charCodeAt(e) & 255) << (24 - 8 * (e % 4));
          ...
          Z = (j.BufferedBlockAlgorithm = m.extend({
            ...
            _process(n) {
              ...
              var m = e / (4 * k);
              const m = n ? a.ceil(m) : a.max((m | 0) - this._minBufferSize, 0);
              n = m * k;
              e = a.min(4 * n, e);
              if (n) {
  ...
  j = j.SHA512 = d.extend({
    ...
    _doProcessBlock(a, c) {
      for (
        ...
        var z = v[u];
        if (16 > u)
          var r = (z.high = a[c + 2 * u] | 0),
            h = (z.low = a[c + 2 * u + 1] | 0);
        else {
          const r = v[u - 15];
          const h = r.high;
          var w = r.low;
          const r = ((h >>> 1) | (w << 31)) ^ ((h >>> 8) | (w << 24)) ^ (h >>> 7);
          ...
          const h = C.high;
          var l = C.low;
          const C = ((h >>> 19) | (l << 13)) ^ ((h << 3) | (l >>> 29)) ^ (h >>> 6);
          ...
          const A = A.low;
          const h = w + h.low;
          const r = r + Y + (h >>> 0 < w >>> 0 ? 1 : 0);
          const h = h + l;
          const r = r + C + (h >>> 0 < l >>> 0 ? 1 : 0);
          const h = h + A;
          const r = r + x + (h >>> 0 < A >>> 0 ? 1 : 0);
          z.high = r;
          z.low = h;
        }
        const Y = (t & U) ^ (~t & V),
    ...
    _doFinalize() {
      const a = this._data, c = a.words, d = 8 * this._nDataBytes, f = 8 * a.sigBytes;
      c[f >>> 5] |= 128 << (24 - (f % 32));
...
(() => {
  ...
  const c = (c.SHA384 = f.extend({
    ...
    _doFinalize() {
      const a = f._doFinalize.call(this);
      a.sigBytes -= 16;
      return a;
    },
  }));
