...
$(function () {
  ...
  //
  mkTool("change-delimiter", function (text) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("tsv-change-delimiter", function (text) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("tsv-columns-to-rows", function (text, asyncResultFn) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("tsv-rows-to-columns", function (text, asyncResultFn) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("text-columns-to-rows", function (text, asyncResultFn) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("text-rows-to-columns", function (text, asyncResultFn) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("tsv-transpose", function (text) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  //
  mkTool("text-transpose", function (text) {
    text = text.replace("\r\n", "\n");
    var lines = text.split("\n");
  ...
  // make ntlm tool work
  //
  mkTool("ntlm-hash", function (text) {
    var utf16le = text.split("").join("\x00") + "\x00";
  ...
  //
  mkTool("seconds-to-hms", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
    for (var i = 0; i < lines.length; i++) {
  ...
  //
  mkTool("hms-to-seconds", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
    for (var i = 0; i < lines.length; i++) {
  ...
  //
  mkTool("seconds-to-human", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
    for (var i = 0; i < lines.length; i++) {
  ...
  //
  mkTool("base-convert", function (text) {
  ...
  //
  mkTool("hex-to-dec", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("dec-to-hex", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("bin-to-dec", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("dec-to-bin", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("bin-to-oct", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("oct-to-bin", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("bin-to-hex", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("hex-to-bin", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("oct-to-dec", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("dec-to-oct", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("oct-to-hex", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("hex-to-oct", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("roman-to-decimal", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("decimal-to-roman", function (text) {
    text = text.replace(/\r\n/g, "\n");
    var lines = text.split("\n");
    var ret = "";
  ...
  //
  mkTool("extract-emails", function (text) {
  ...
  //
  mkTool("random-pick", function (text) {
    var lines = text.split("\n");
  ...
  mkTool("hex-to-rgb", function (text) {
    $("#action-error").hide();
  ...
  mkTool("rgb-to-hex", function (text) {
    $("#action-error").hide();
