...
function saveAheadFilter() {
  ...
  localStorage.setItem(
    LOCAL_STORAGE_SETTINGS_AHEAD_FILTER,
    UF_SETTINGS_AHEAD_FILTER
  );
}
function setAheadFilter() {
  UF_SETTINGS_AHEAD_FILTER = localStorage.getItem(
    LOCAL_STORAGE_SETTINGS_AHEAD_FILTER
  );
...
function saveCsvDisplay() {
  ...
  localStorage.setItem(
    LOCAL_STORAGE_SETTINGS_CSV_DISPLAY,
    JSON.stringify(UF_SETTINGS_CSV_DISPLAY)
  );
}
function setCsvDisplay() {
  UF_SETTINGS_CSV_DISPLAY = localStorage.getItem(
    LOCAL_STORAGE_SETTINGS_CSV_DISPLAY
  );
