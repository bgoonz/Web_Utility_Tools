...
*/
  ...
  jsonlint.parse = function (input) {
    ...
    var dougJSONParse =
      typeof ___dougJSONParse === "undefined"
        ? require("./doug-json-parse")
        : ___dougJSONParse;
    try {
      dougJSONParse(input);
    } catch (e) {
      if (/Duplicate key|Bad string|Unexpected/.test(e.message)) {
        ...
        this.parseError(e.message, {
          line: line,
          col: col,
          message: e.message.replace(/./, function (l) {
...
if (typeof module === "object" && module.exports) module.exports = jsonlint;
