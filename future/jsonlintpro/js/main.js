  ...
  $.fn.linedtextarea = function (options) {
    ...
    return this.each(function () {
      ...
      var textareaNewWidth =
        originalTextAreaWidth - sidebarWidth - paddingHorizontal;
...
(function () {
  ...
  (w.isEqual = function (n, t) {
    ...
    (w.random = function (n, t) {
      return (
        null == t && ((t = n), (n = 0)), n + (0 | (Math.random() * (t - n + 1)))
      );
    });
  var T = {
    escape: {
...
(function () {
  ...
  g.VERSION = "0.9.9";
  var e = k._;
  !e && "undefined" !== typeof require && (e = require("underscore"));
    ...
    h = (g.Events = {
          ...
          if (((a = g[i]), (d = this._events[a]))) {
            ...
            if (b || c) {
              ...
              for (j = d.length; h < j; h++)
                (f = d[h]),
                  ((b && b !== (f.callback._callback || f.callback)) ||
                    (c && c !== f.context)) &&
                    l.push(f);
            }
            this._events[a] = l;
      ...
      listenTo: function (a, b, c) {
        var d = this._listeners || (this._listeners = {}),
          f = a._listenerId || (a._listenerId = e.uniqueId("l"));
        d[f] = a;
        a.on(b, c || this, this);
        return this;
      },
  ...
  e.extend(o.prototype, h, {
    ...
    set: function (a, b, c) {
      ...
      for (d in f)
        (b = f[d]), l ? delete g[d] : (g[d] = b), this._changes.push(d, b);
      this._hasComputed = !1;
      a || this.change(c);
      return this;
    },
    unset: function (a, b) {
      return this.set(a, void 0, e.extend({}, b, { unset: !0 }));
    },
    clear: function (a) {
      var b = {},
        c;
      for (c in this.attributes) b[c] = void 0;
      return this.set(b, e.extend({}, a, { unset: !0 }));
    },
    fetch: function (a) {
      a = a ? e.clone(a) : {};
    ...
    save: function (a, b, c) {
      ...
      a = e.extend({}, c, { silent: !0 });
      if (
        (d && !this.set(d, c.wait ? a : c)) ||
        (!d && !this._validate(null, c))
      )
        return !1;
      var q = this,
        i = c.success;
    ...
    url: function () {
      var a =
        e.result(this, "urlRoot") || e.result(this.collection, "url") || u();
      return this.isNew()
        ? a
        : a +
            ("/" === a.charAt(a.length - 1) ? "" : "/") +
    ...
    _computeChanges: function (a) {
      ...
      for (
        ...
        b[g] ||
          ((b[g] = !0),
          d[g] !== i &&
            ((this.changed[g] = i), a && (c.push(g, i), (d[g] = i))));
      }
      a && (this._changes = []);
      this._hasComputed = !0;
      return c;
    ...
    _validate: function (a, b) {
      ...
      var a = e.extend({}, this.attributes, a),
        c = this.validate(a, b);
      if (!c) return !0;
  ...
  var p = (g.Collection = function (a, b) {
    ...
    this._reset();
    this.initialize.apply(this, arguments);
    a && this.reset(a, e.extend({ silent: !0 }, b));
  });
  e.extend(p.prototype, h, {
    ...
    add: function (a, b) {
      var c,
        ...
        g,
        h = b && b.at,
        i = null == (b && b.sort) ? !0 : b.sort,
        a = e.isArray(a) ? a.slice() : [a];
      for (c = a.length - 1; 0 <= c; c--)
        (d = this._prepareModel(a[c], b))
          ? ((a[c] = d),
            (f = null != d.id && this._byId[d.id]) || this._byCid[d.cid]
              ? (b && b.merge && f && (f.set(d.attributes, b), (g = i)),
                a.splice(c, 1))
              : (d.on("all", this._onModelEvent, this),
                (this._byCid[d.cid] = d),
                null != d.id && (this._byId[d.id] = d)))
          : (this.trigger("error", this, a[c], b), a.splice(c, 1));
      a.length && (g = i);
      this.length += a.length;
      c = [null != h ? h : this.models.length, 0];
      z.apply(c, a);
      A.apply(this.models, c);
      g && this.comparator && null == h && this.sort({ silent: !0 });
      ...
      for (d = a.length; c < d; c++)
        if ((g = this.get(a[c])))
          delete this._byId[g.id],
            ...
            this.length--,
            b.silent || ((b.index = f), g.trigger("remove", g, this, b)),
            this._removeReference(g);
      return this;
    },
    push: function (a, b) {
      a = this._prepareModel(a, b);
      this.add(a, e.extend({ at: this.length }, b));
      return a;
    },
    pop: function (a) {
    ...
    get: function (a) {
      return null == a
        ? void 0
        : this._byId[null != a.id ? a.id : a] || this._byCid[a.cid || a];
    },
    at: function (a) {
    ...
    sort: function (a) {
      ...
      e.isString(this.comparator) || 1 === this.comparator.length
        ? (this.models = this.sortBy(this.comparator, this))
        : this.models.sort(e.bind(this.comparator, this));
    ...
    update: function (a, b) {
      var c,
        ...
        i = [],
        m = {},
        j = this.model.prototype.idAttribute,
        b = e.extend({ add: !0, merge: !0, remove: !0 }, b);
    ...
    reset: function (a, b) {
      ...
      this._reset();
      a && this.add(a, e.extend({ silent: !0 }, b));
  ...
  e.each(
    "forEach each map collect reduce foldl inject reduceRight foldr find detect filter select reject every all some any include contains invoke max min sortedIndex toArray size first head take initial rest tail last without indexOf shuffle lastIndexOf isEmpty".split(
      " "
    ),
    function (a) {
  ...
  e.extend(v.prototype, h, {
    ...
    _bindRoutes: function () {
      if (this.routes)
        for (var a, b = e.keys(this.routes); null != (a = b.pop()); )
  ...
  e.extend(j.prototype, h, {
    ...
    start: function (a) {
      ...
      j.started = !0;
      this.options = e.extend({}, { root: "/" }, this.options, a);
  ...
  var x = (g.View = function (a) {
    ...
    I = /^(\S+)\s*(.*)$/,
    J = "model collection el id attributes className tagName events".split(" ");
  e.extend(x.prototype, h, {
    ...
    _ensureElement: function () {
      if (this.el) this.setElement(e.result(this, "el"), !1);
      else {
...
var checkDiff = function (before, after) {
  ...
  console.assert(
    JSON.stringify(before) === JSON.stringify(_before),
    "Expected",
    before,
    "got",
    _before
  ...
  console.assert(
    JSON.stringify(after) === JSON.stringify(_after),
    "Expected",
    after,
    "got",
    _after
...
var utils = {
  ...
  getTextBoundingRect: function (input, selectionStart, selectionEnd, debug) {
    ...
    topPos += isNaN(getInputCSS("border-top-width", true))
      ? 0
      : getInputCSS("border-top-width", true);
    leftPos += getInputCSS("padding-left", true);
    leftPos += isNaN(getInputCSS("border-left-width", true))
      ? 0
      : getInputCSS("border-left-width", true);
  ...
  ValidatorView = Backbone.View.extend({
    ...
    _handleParseException: function () {
      ...
      if (
        ...
        offset = utils.getTextBoundingRect(
          this.textarea[0],
          lineStart,
          lineEnd,
          false
