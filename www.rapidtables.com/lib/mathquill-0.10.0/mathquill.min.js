...
!(function () {
  ...
  function e(t) {
    var e = t.length - 1;
    return function () {
      var n = Ot.call(arguments, 0, e),
        i = Ot.call(arguments, e);
  ...
  function r(t) {
    s("a direction was passed", t === Qt || t === Tt);
  }
  function o(t, e, n) {
    s("a parent is always present", t),
      s(
        ...
        (function () {
          return e ? e[Tt] === n && e.parent === t : t.ends[Qt] === n;
        })()
      ),
      s(
        "rightward is properly set up",
        (function () {
          return n ? n[Qt] === e && n.parent === t : t.ends[Tt] === e;
        })()
      );
  }
  function a() {
  ...
  function c(e) {
    function n(t) {
      var e, n;
      return t && t.nodeType
        ? ((e = Ct(t).children(".mq-root-block").attr(qt)),
    ...
    function i(t, e) {
      ...
      for (n in e)
        e.hasOwnProperty(n) && ((i = e[n]), (r = Bt[n]), (t[n] = r ? r(i) : i));
    }
    var s, r, o;
    if (!(e >= g && b >= e))
      throw (
    ...
    (s = {}),
          ...
          (t.init = function (t) {
            ...
            (t.__mathquillify = function (t) {
              ...
              n.createTextarea(),
                ...
                (i.jQ = Ct('<span class="mq-root-block"/>')
                  .attr(qt, i.id)
                  .appendTo(s)),
                this.latex(e.text()),
      ...
      (s.EditableField = jt(r, function (e, n) {
        (e.__mathquillify = function () {
          ...
          (e.select = function () {
            ...
            for (t.notify("move").cursor.insAtRightEnd(t.root); t.cursor[Qt]; )
              t.selectLeft();
            return this;
          }),
  ...
  function p(t, e) {
    (t.jQadd = function () {
      ...
      (t.reflow = function () {
        ...
        Y(this.delimjQs, xt(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
      });
  }
  function d(t, e) {
    var e = e || t,
      n = pt[t],
      s = pt[e];
    (Et[t] = i(ft, Qt, t, n, e, s)), (Et[n] = i(ft, Tt, t, n, e, s));
  }
  var m,
    g,
    b,
    ...
    bt,
    vt = window.jQuery,
    wt = "mathquill-command-id",
    qt = "mathquill-block-id",
    xt = Math.min,
    yt = Math.max,
    Ot = [].slice,
    kt = e(function (t, n) {
    ...
    Ct = jt(vt, function (t) {
      (t.insDirOf = function (t, e) {
        ...
        (t.insAtDirEnd = function (t, e) {
          return t === Qt ? this.prependTo(e) : this.appendTo(e);
        });
    }),
    Dt = jt(function (t) {
      (t.parent = 0),
        ...
        (t.init = function (t, e, n) {
          (this.parent = t), (this[Qt] = e), (this[Tt] = n);
        }),
        (this.copy = function (t) {
          return Dt(t.parent, t[Qt], t[Tt]);
        });
    }),
    St = jt(function (t) {
      function e() {
      ...
      (this.byId = {}),
        ...
        (t.jQize = function (t) {
          ...
          var n;
          for (t = Ct(t || this.html()), n = 0; n < t.length; n += 1) e(t[n]);
          return t;
        }),
        (t.createDir = function (t, e) {
          ...
          return (
            ...
            (e[t] = n.adopt(e.parent, e[Qt], e[Tt])),
            n
          );
        }),
        (t.createLeftOf = function (t) {
          return this.createDir(Qt, t);
        }),
        ...
        (t.isEmpty = function () {
          return 0 === this.ends[Qt] && 0 === this.ends[Tt];
        }),
        (t.children = function () {
          return _t(this.ends[Qt], this.ends[Tt]);
        }),
        ...
        (t.withDirAdopt = function (t, e, n, i) {
          return _t(this, this).withDirAdopt(t, e, n, i), this;
        }),
        (t.adopt = function (t, e, n) {
          return _t(this, this).adopt(t, e, n), this;
        }),
        (t.disown = function () {
          return _t(this, this).disown(), this;
        }),
        (t.remove = function () {
    ...
    _t = jt(function (t) {
      (t.init = function (t, e, n) {
        ...
        (t.jQ = Ct()),
        (t.withDirAdopt = function (t, e, n, i) {
          return t === Qt ? this.adopt(e, n, i) : this.adopt(e, i, n);
        }),
        (t.adopt = function (t, e, n) {
          var i, s, r;
          return (
            ...
            (s = i.ends[Qt])
              ? ((r = i.ends[Tt]),
                e || (t.ends[Qt] = s),
                n ? (n[Qt] = r) : (t.ends[Tt] = r),
                (i.ends[Tt][Tt] = n),
                i.each(function (n) {
                  (n[Qt] = e), (n.parent = t), e && (e[Tt] = n), (e = n);
                }),
                i)
              : this
          );
        ...
        (t.disown = function () {
          ...
          return !i || n.disowned
            ...
            : ((n.disowned = !0),
              ...
              o(e, i[Qt], i),
              o(e, t, t[Tt]),
              i[Qt] ? (i[Qt][Tt] = t[Tt]) : (e.ends[Qt] = t[Tt]),
              t[Tt] ? (t[Tt][Qt] = i[Qt]) : (e.ends[Tt] = i[Qt]),
              n);
        }),
        (t.remove = function () {
          return (
        ...
        (t.each = n(function (t) {
          var e,
            ...
            i = n.ends[Qt];
          if (!i) return n;
          for (; i !== n.ends[Tt][Tt] && ((e = t(i)), e !== !1); i = i[Tt]);
          return n;
        })),
        (t.fold = function (t, e) {
          return (
    ...
    At = jt(Dt, function (t) {
      (t.init = function (t, e) {
        ...
        (t.show = function () {
          return (
            ...
            "intervalId" in this
              ...
              : (this[Tt]
                  ? this.selection && this.selection.ends[Qt][Qt] === this[Qt]
                    ? this.jQ.insertBefore(this.selection.jQ)
                    : this.jQ.insertBefore(this[Tt].jQ.first())
        ...
        (t.withDirInsertAt = function (t, e, n, i) {
          e !== this.parent && this.parent.blur && this.parent.blur(),
            (this.parent = e),
            (this[t] = n),
            (this[-t] = i);
        }),
        ...
        (t.unwrapGramp = function () {
          ...
          if (
            ...
            if (this[Qt]) this[Tt] = this[Qt][Tt];
            else
              for (; !this[Tt]; ) {
                if (((this.parent = this.parent[Tt]), !this.parent)) {
                  (this[Tt] = t[Tt]), (this.parent = e);
                  break;
                }
                this[Tt] = this.parent.ends[Qt];
              }
          this[Tt] ? this.insLeftOf(this[Tt]) : this.insAtRightEnd(e),
            t.jQ.remove(),
            t[Qt].siblingDeleted && t[Qt].siblingDeleted(i.options, Tt),
            t[Tt].siblingDeleted && t[Tt].siblingDeleted(i.options, Qt);
        }),
        ...
        (t.select = function () {
          var t,
            ...
            a,
            l = this.anticursor;
          if (this[Qt] === l[Qt] && this.parent === l.parent) return !1;
          ...
          return (
            o === Tt && ((i = n), (r = t)),
            i instanceof Dt && (i = i[Tt]),
            r instanceof Dt && (r = r[Qt]),
        ...
        (t.deleteSelection = function () {
          this.selection &&
            ((this[Qt] = this.selection.ends[Qt][Qt]),
      ...
      (t.init = function (t, e, n) {
        ...
        (t.handle = function (t, e) {
          ...
          i &&
            ...
            e === Qt || e === Tt ? i.fns[t](e, n) : i.fns[t](n));
        });
      var e = [];
  ...
  (l.prototype = Ft.p),
      ...
      return function (n, i) {
        ...
        function l(e) {
          (g = e),
            ...
            m &&
              s(function () {
                v[0].select && v[0].select(), (q = t), clearTimeout(d);
              }),
            a();
        }
        function c(t) {
        ...
        var d,
          ...
          q = t;
        return (
          w.bind("keydown keypress input keyup focusout paste", function () {
            q();
          }),
          (m = !1),
          ...
          .blur(function () {
            (i.blurred = !0),
              (n = setTimeout(function () {
                s.postOrder("intentionalBlur"), r.clearSelection(), e();
              })),
              Ct(window).on("blur", t);
          }),
          (i.blurred = !0),
    ...
    St.open(function (t) {
      (t.keystroke = function (t, e, n) {
        ...
        switch (t) {
          ...
          case "Shift-Tab":
          case "Shift-Esc":
            return void n.escapeDir(Qt, t, e);
          case "End":
          ...
          case "Ctrl-End":
            ...
            break;
          case "Shift-End":
            for (; i[Tt]; ) n.selectRight();
            break;
          case "Ctrl-Shift-End":
            for (; i[Tt] || i.parent !== n.root; ) n.selectRight();
            break;
          case "Home":
          ...
          case "Ctrl-Home":
            ...
            break;
          case "Shift-Home":
            for (; i[Qt]; ) n.selectLeft();
            break;
          case "Ctrl-Shift-Home":
            for (; i[Qt] || i.parent !== n.root; ) n.selectLeft();
            break;
          case "Left":
            n.moveLeft();
            break;
          ...
          case "Down":
            ...
            break;
          case "Shift-Up":
            if (i[Qt]) for (; i[Qt]; ) n.selectLeft();
            else n.selectLeft();
          case "Shift-Down":
            if (i[Tt]) for (; i[Tt]; ) n.selectRight();
            else n.selectRight();
          case "Ctrl-Up":
            break;
          case "Ctrl-Down":
          ...
          case "Meta-A":
          case "Ctrl-A":
            for (n.notify("move").cursor.insAtRightEnd(n.root); i[Qt]; )
              n.selectLeft();
            break;
          default:
            return;
    ...
    It.open(function (t) {
      function e(t, e) {
        ...
        return (
          n[Tt][i]
            ? n.insAtLeftEnd(n[Tt][i])
            : n[Qt][i]
            ? n.insAtRightEnd(n[Qt][i])
      ...
      this.onNotify(function (t) {
        ...
        (Bt.leftRightIntoCmdGoes = function (t) {
          if (t && "up" !== t && "down" !== t)
            throw (
        ...
        (t.deleteDir = function (t) {
          ...
          return (
            ...
            e[Qt].siblingDeleted && e[Qt].siblingDeleted(e.options, Tt),
            e[Tt].siblingDeleted && e[Tt].siblingDeleted(e.options, Qt),
        ...
        (t.ctrlDeleteDir = function (t) {
          r(t);
          var e = this.cursor;
          return !e[Qt] || e.selection
            ? ctrlr.deleteDir()
            : (this.notify("edit"),
              _t(e.parent.ends[Qt], e[Qt]).remove(),
              e.insAtDirEnd(Qt, e.parent),
              e[Qt].siblingDeleted && e[Qt].siblingDeleted(e.options, Tt),
              e[Tt].siblingDeleted && e[Tt].siblingDeleted(e.options, Qt),
              e.parent.bubble("reflow"),
              this);
    ...
    (x = (function () {
      ...
      function e(t) {
        ...
        for (e = 1; e < t.length; e += 1)
          t[e].children().adopt(n, n.ends[Tt], 0);
        return n;
      }
      var n = w.string,
        i = w.regex,
      ...
      (t.exportLatex = function () {
        ...
        (t.writeLatex = function (t) {
          ...
          return (
            r &&
              !r.isEmpty() &&
              (r.children().adopt(n.parent, n[Qt], n[Tt]),
              (e = r.jQize()),
              e.insertBefore(n.jQ),
              (n[Qt] = r.ends[Tt]),
              r.finalizeInsert(n.options, n),
              r.ends[Tt][Tt].siblingCreated &&
                r.ends[Tt][Tt].siblingCreated(n.options, Qt),
              r.ends[Qt][Qt].siblingCreated &&
                r.ends[Qt][Qt].siblingCreated(n.options, Tt),
        ...
        (t.renderLatexText = function (t) {
          ...
          if (
            ...
            for (u = 0; u < c.length; u += 1) c[u].adopt(h, h.ends[Tt], 0);
        ...
        this.container.bind("mousedown.mathquill", function (n) {
          ...
          function r(t) {
            (u.blink = h),
              ...
              Ct(t.target.ownerDocument)
                .unbind("mousemove", s)
                .unbind("mouseup", r);
          }
          var o,
            a = Ct(n.target).closest(".mq-root-block"),
            l = St.byId[a.attr(qt) || e.attr(qt)],
            c = l.controller,
            u = c.cursor,
            h = u.blink,
            f = c.textareaSpan,
          ...
          c.blurred && (c.editable || a.prepend(f), p.focus()),
            ...
            (u.blink = t),
            c.seek(Ct(n.target), n.pageX, n.pageY).cursor.startSelection(),
            a.mousemove(i),
            Ct(n.target.ownerDocument).mousemove(s).mouseup(r);
        });
      };
    }),
    It.open(function (t) {
      t.seek = function (t, e, n) {
        ...
        return (
          t &&
            ((i = t.attr(qt) || t.attr(wt)),
            i || ((r = t.parent()), (i = r.attr(qt) || r.attr(wt)))),
    ...
    It.open(function (t) {
      (Mt.p.substituteTextarea = function () {
        return Ct(
    ...
    (y = jt(St, function (t, e) {
      t.finalizeInsert = function (t, e) {
        ...
        n.postOrder("finalizeTree", t),
          ...
          n.postOrder("blur"),
          n.postOrder("reflow"),
          n[Tt].siblingCreated && n[Tt].siblingCreated(t, Qt),
          n[Qt].siblingCreated && n[Qt].siblingCreated(t, Tt),
          n.bubble("reflow");
      };
    })),
    (O = jt(y, function (t, e) {
      (t.init = function (t, n, i) {
        ...
        (t.parser = function () {
          ...
          return t.times(e.numBlocks()).map(function (t) {
            e.blocks = t;
            for (var n = 0; n < t.length; n += 1) t[n].adopt(e, e.ends[Tt], 0);
            return e;
          });
        }),
        (t.createLeftOf = function (t) {
          ...
          n.createBlocks(),
            ...
            i && (i.adopt(n.ends[Qt], 0, 0), i.jQ.appendTo(n.ends[Qt].jQ)),
        ...
        (t.createBlocks = function () {
          var t,
            ...
            s = (n.blocks = Array(i));
          for (t = 0; i > t; t += 1)
            (e = s[t] = T()), e.adopt(n, n.ends[Tt], 0);
        }),
        (t.placeCursor = function (t) {
          t.insAtRightEnd(
            this.foldChildren(this.ends[Qt], function (t, e) {
        ...
        (t.seek = function (t, e) {
          function n(t) {
            var e = {};
            return (
              (e[Qt] = t.jQ.offset().left),
              (e[Tt] = e[Qt] + t.jQ.outerWidth()),
              e
            );
          }
          var i,
    ...
    (T = jt(y, function (t, e) {
      (t.join = function (t) {
        ...
        (t.text = function () {
          return this.ends[Qt] === this.ends[Tt] && 0 !== this.ends[Qt]
            ? this.ends[Qt].text()
            : this.join("text");
        }),
        (t.keystroke = function (t, n, i) {
          return !i.options.spaceBehavesLikeTab ||
            ...
            : (n.preventDefault(),
              void i.escapeDir("Shift-Spacebar" === t ? Qt : Tt, t, n));
        }),
        ...
        (t.seek = function (t, e) {
          ...
          if (t < this.ends[Qt].jQ.offset().left) return e.insAtLeftEnd(this);
          for (; t < n.jQ.offset().left; ) n = n[Qt];
          return n.seek(t, e);
        }),
    ...
    (zt.StaticMath = function (t) {
      return jt(t.AbstractMathQuill, function (e, n) {
        (this.RootBlock = T),
          (e.__mathquillify = function () {
            return (
    ...
    (C = jt(T, u)),
    (zt.MathField = function (e) {
      return jt(e.EditableField, function (e, n) {
        (this.RootBlock = C),
    ...
    (D = jt(St, function (t, e) {
      ...
      (t.ctrlSeq = "\\text"),
        ...
        (t.jQadd = function (t) {
          e.jQadd.call(this, t),
            this.ends[Qt] && this.ends[Qt].jQadd(this.jQ[0].firstChild);
        }),
        (t.createLeftOf = function (t) {
          var n,
            i = this;
          if (
            ...
            i[Tt].siblingCreated && i[Tt].siblingCreated(t.options, Qt),
            i[Qt].siblingCreated && i[Qt].siblingCreated(t.options, Tt),
            i.bubble("reflow"),
            t.insAtRightEnd(i),
            i.replacedText)
          )
          ...
          -a * l > a * o && e[-a].moveTowards(-a, e),
            e.anticursor
              ? e.anticursor.parent === this &&
                ((c = e[Qt] && e[Qt].text.length),
                this.anticursorPosition === c
                  ? (e.anticursor = Dt.copy(e))
                  : (this.anticursorPosition < c
                      ? ((u = e[Qt].splitRight(this.anticursorPosition)),
                        (e[Qt] = u))
                      : (u = e[Tt].splitRight(this.anticursorPosition - c)),
                    (e.anticursor = Dt(this, u[Qt], u))))
              : (this.anticursorPosition = e[Qt] && e[Qt].text.length);
        }),
        (t.blur = function () {
    ...
    (S = jt(St, function (t, e) {
      function n(t, e) {
        return e.charAt(t === Qt ? 0 : -1 + e.length);
      }
      (t.init = function (t) {
        e.init.call(this), (this.text = t);
      }),
        (t.jQadd = function (t) {
          (this.dom = t), (this.jQ = Ct(t));
        }),
        (t.jQize = function () {
        ...
        (t.insTextAtDirEnd = function (t, e) {
          r(e), e === Tt ? this.appendText(t) : this.prependText(t);
        }),
        (t.splitRight = function (t) {
          var e = S(this.text.slice(t)).adopt(this.parent, this, this[Tt]);
          return (
        ...
        (t.moveTowards = function (t, e) {
          ...
          return (
            ...
            (i = n(-t, this.text)),
            (s = this[-t]),
            s ? s.insTextAtDirEnd(i, t) : S(i).createDir(-t, e),
        ...
        (t.selectTowards = function (t, e) {
          ...
          return (
            ...
            (s = n(-t, this.text)),
            i[t] === this
              ? ((o = S(s).createDir(t, e)), (i[t] = o), e.insDirOf(t, o))
              : ((a = this[-t]),
                a
    ...
    (Et.$ = Lt.text = Lt.textnormal = Lt.textrm = Lt.textup = Lt.textmd = D),
    (Lt.em =
      Lt.italic =
      Lt.italics =
      Lt.emph =
      ...
      (t.init = function (t) {
        ...
        (t.createBlocks = function () {
          e.createBlocks.call(this),
            (this.ends[Qt].cursor = this.cursor),
            (this.ends[Qt].write = function (t, e) {
              "$" !== e
    ...
    (L = jt(C, function (t, e) {
      (t.keystroke = function (t) {
        ...
        (t.write = function (t, e) {
          if ((t.show().deleteSelection(), "$" === e)) _(t).createLeftOf(t);
          else {
            var n;
            "<" === e ? (n = "&lt;") : ">" === e && (n = "&gt;"),
    ...
    (zt.TextField = function (t) {
      return jt(t.EditableField, function (t, e) {
        (this.RootBlock = L),
        ...
        (t.ctrlSeq = "\\"),
          ...
          (t.createBlocks = function () {
            e.createBlocks.call(this),
              ...
              (this.ends[Qt].keystroke = function (t, n, i) {
            ...
            if ((e.createLeftOf.call(this, t), this._replacedFragment)) {
              ...
              this.jQ = this._replacedFragment.jQ
                ...
                .bind("mousedown mousemove", function (t) {
                  return Ct((t.target = n)).trigger(t), !1;
                })
          ...
          (t.renderCommand = function (t) {
            ...
            (this.jQ = this.jQ.last()),
              this.remove(),
              this[Tt] ? t.insLeftOf(this[Tt]) : t.insAtRightEnd(this.parent),
              (e = this.ends[Qt].latex()),
              e || (e = " "),
              (n = Lt[e]),
              n
                ? ((n = n(e)),
    ...
    (Lt["≠"] = Lt.ne = Lt.neq = i(Q, "\\ne ", "&ne;")),
    (Lt.ast = Lt.star = Lt.loast = Lt.lowast = i(Q, "\\ast ", "&lowast;")),
    (Lt.therefor = Lt.therefore = i(Q, "\\therefore ", "&there4;")),
    (Lt.cuz = Lt.because = i(Q, "\\because ", "&#8757;")),
    (Lt.prop = Lt.propto = i(Q, "\\propto ", "&prop;")),
    (Lt["≈"] = Lt.asymp = Lt.approx = i(Q, "\\approx ", "&asymp;")),
    (Lt.isin = Lt["in"] = i(Q, "\\in ", "&isin;")),
    (Lt.ni = Lt.contains = i(Q, "\\ni ", "&ni;")),
    (Lt.notni =
      Lt.niton =
      Lt.notcontains =
      Lt.doesnotcontain =
        i(Q, "\\not\\ni ", "&#8716;")),
    (Lt.sub = Lt.subset = i(Q, "\\subset ", "&sub;")),
    (Lt.sup = Lt.supset = Lt.superset = i(Q, "\\supset ", "&sup;")),
    (Lt.nsub =
      Lt.notsub =
      Lt.nsubset =
      Lt.notsubset =
    ...
    (Lt.nsupe =
      ...
      Lt.notsuperseteq =
        i(Q, "\\not\\supseteq ", "&#8841;")),
    (Lt.N = Lt.naturals = Lt.Naturals = i(j, "\\mathbb{N}", "&#8469;")),
    (Lt.P =
      Lt.primes =
      Lt.Primes =
      Lt.projective =
      ...
      Lt.Probability =
        i(j, "\\mathbb{P}", "&#8473;")),
    (Lt.Z = Lt.integers = Lt.Integers = i(j, "\\mathbb{Z}", "&#8484;")),
    (Lt.Q = Lt.rationals = Lt.Rationals = i(j, "\\mathbb{Q}", "&#8474;")),
    (Lt.R = Lt.reals = Lt.Reals = i(j, "\\mathbb{R}", "&#8477;")),
    (Lt.C =
      Lt.complex =
      Lt.Complex =
      Lt.complexes =
    ...
    (Lt.H =
      ...
      Lt.Quaternions =
        i(j, "\\mathbb{H}", "&#8461;")),
    (Lt.quad = Lt.emsp = i(j, "\\quad ", "    ")),
    (Lt.qquad = i(j, "\\qquad ", "        ")),
    (Lt.diamond = i(j, "\\diamond ", "&#9671;")),
    (Lt.bigtriangleup = i(j, "\\bigtriangleup ", "&#9651;")),
    (Lt.ominus = i(j, "\\ominus ", "&#8854;")),
    (Lt.uplus = i(j, "\\uplus ", "&#8846;")),
    (Lt.bigtriangledown = i(j, "\\bigtriangledown ", "&#9661;")),
    (Lt.sqcap = i(j, "\\sqcap ", "&#8851;")),
    (Lt.triangleleft = i(j, "\\triangleleft ", "&#8882;")),
    (Lt.sqcup = i(j, "\\sqcup ", "&#8852;")),
    (Lt.triangleright = i(j, "\\triangleright ", "&#8883;")),
    (Lt.odot = i(j, "\\odot ", "&#8857;")),
    (Lt.bigcirc = i(j, "\\bigcirc ", "&#9711;")),
    (Lt.dagger = i(j, "\\dagger ", "&#0134;")),
    (Lt.ddagger = i(j, "\\ddagger ", "&#135;")),
    (Lt.wr = i(j, "\\wr ", "&#8768;")),
    (Lt.amalg = i(j, "\\amalg ", "&#8720;")),
    (Lt.models = i(j, "\\models ", "&#8872;")),
    (Lt.prec = i(j, "\\prec ", "&#8826;")),
    (Lt.succ = i(j, "\\succ ", "&#8827;")),
    (Lt.preceq = i(j, "\\preceq ", "&#8828;")),
    (Lt.succeq = i(j, "\\succeq ", "&#8829;")),
    (Lt.simeq = i(j, "\\simeq ", "&#8771;")),
    (Lt.mid = i(j, "\\mid ", "&#8739;")),
    (Lt.ll = i(j, "\\ll ", "&#8810;")),
    (Lt.gg = i(j, "\\gg ", "&#8811;")),
    (Lt.parallel = i(j, "\\parallel ", "&#8741;")),
    (Lt.bowtie = i(j, "\\bowtie ", "&#8904;")),
    (Lt.sqsubset = i(j, "\\sqsubset ", "&#8847;")),
    (Lt.sqsupset = i(j, "\\sqsupset ", "&#8848;")),
    (Lt.smile = i(j, "\\smile ", "&#8995;")),
    (Lt.sqsubseteq = i(j, "\\sqsubseteq ", "&#8849;")),
    (Lt.sqsupseteq = i(j, "\\sqsupseteq ", "&#8850;")),
    (Lt.doteq = i(j, "\\doteq ", "&#8784;")),
    (Lt.frown = i(j, "\\frown ", "&#8994;")),
    (Lt.vdash = i(j, "\\vdash ", "&#8870;")),
    (Lt.dashv = i(j, "\\dashv ", "&#8867;")),
    (Lt.longleftarrow = i(j, "\\longleftarrow ", "&#8592;")),
    (Lt.longrightarrow = i(j, "\\longrightarrow ", "&#8594;")),
    (Lt.Longleftarrow = i(j, "\\Longleftarrow ", "&#8656;")),
    (Lt.Longrightarrow = i(j, "\\Longrightarrow ", "&#8658;")),
    (Lt.longleftrightarrow = i(j, "\\longleftrightarrow ", "&#8596;")),
    (Lt.updownarrow = i(j, "\\updownarrow ", "&#8597;")),
    (Lt.Longleftrightarrow = i(j, "\\Longleftrightarrow ", "&#8660;")),
    (Lt.Updownarrow = i(j, "\\Updownarrow ", "&#8661;")),
    (Lt.mapsto = i(j, "\\mapsto ", "&#8614;")),
    (Lt.nearrow = i(j, "\\nearrow ", "&#8599;")),
    (Lt.hookleftarrow = i(j, "\\hookleftarrow ", "&#8617;")),
    (Lt.hookrightarrow = i(j, "\\hookrightarrow ", "&#8618;")),
    (Lt.searrow = i(j, "\\searrow ", "&#8600;")),
    (Lt.leftharpoonup = i(j, "\\leftharpoonup ", "&#8636;")),
    (Lt.rightharpoonup = i(j, "\\rightharpoonup ", "&#8640;")),
    (Lt.swarrow = i(j, "\\swarrow ", "&#8601;")),
    (Lt.leftharpoondown = i(j, "\\leftharpoondown ", "&#8637;")),
    (Lt.rightharpoondown = i(j, "\\rightharpoondown ", "&#8641;")),
    (Lt.nwarrow = i(j, "\\nwarrow ", "&#8598;")),
    (Lt.ldots = i(j, "\\ldots ", "&#8230;")),
    (Lt.cdots = i(j, "\\cdots ", "&#8943;")),
    (Lt.vdots = i(j, "\\vdots ", "&#8942;")),
    ...
    (Lt.wp = i(j, "\\wp ", "&#8472;")),
    (Lt.bot = i(j, "\\bot ", "&#8869;")),
    (Lt.clubsuit = i(j, "\\clubsuit ", "&#9827;")),
    (Lt.diamondsuit = i(j, "\\diamondsuit ", "&#9826;")),
    (Lt.heartsuit = i(j, "\\heartsuit ", "&#9825;")),
    (Lt.spadesuit = i(j, "\\spadesuit ", "&#9824;")),
    (Lt.oint = i(j, "\\oint ", "&#8750;")),
    (Lt.bigcap = i(j, "\\bigcap ", "&#8745;")),
    (Lt.bigcup = i(j, "\\bigcup ", "&#8746;")),
    (Lt.bigsqcup = i(j, "\\bigsqcup ", "&#8852;")),
    (Lt.bigvee = i(j, "\\bigvee ", "&#8744;")),
    (Lt.bigwedge = i(j, "\\bigwedge ", "&#8743;")),
    (Lt.bigodot = i(j, "\\bigodot ", "&#8857;")),
    (Lt.bigotimes = i(j, "\\bigotimes ", "&#8855;")),
    (Lt.bigoplus = i(j, "\\bigoplus ", "&#8853;")),
    (Lt.biguplus = i(j, "\\biguplus ", "&#8846;")),
    (Lt.lfloor = i(j, "\\lfloor ", "&#8970;")),
    (Lt.rfloor = i(j, "\\rfloor ", "&#8971;")),
    (Lt.lceil = i(j, "\\lceil ", "&#8968;")),
    (Lt.rceil = i(j, "\\rceil ", "&#8969;")),
    (Lt.opencurlybrace = Lt.lbrace = i(j, "\\lbrace ", "{")),
    (Lt.closecurlybrace = Lt.rbrace = i(j, "\\rbrace ", "}")),
    (Lt.lbrack = i(j, "[")),
    (Lt.rbrack = i(j, "]")),
    (Lt["∫"] = Lt["int"] = Lt.integral = i(k, "\\int ", "<big>&int;</big>")),
    (Lt.slash = i(j, "/")),
    (Lt.vert = i(j, "|")),
    (Lt.perp = Lt.perpendicular = i(j, "\\perp ", "&perp;")),
    (Lt.nabla = Lt.del = i(j, "\\nabla ", "&nabla;")),
    (Lt.hbar = i(j, "\\hbar ", "&#8463;")),
    (Lt.AA = Lt.Angstrom = Lt.angstrom = i(j, "\\text\\AA ", "&#8491;")),
    (Lt.ring = Lt.circ = Lt.circle = i(j, "\\circ ", "&#8728;")),
    (Lt.bull = Lt.bullet = i(j, "\\bullet ", "&bull;")),
    (Lt.setminus = Lt.smallsetminus = i(j, "\\setminus ", "&#8726;")),
    (Lt.not = Lt["¬"] = Lt.neg = i(j, "\\neg ", "&not;")),
    (Lt["…"] =
      Lt.dots =
      Lt.ellip =
      Lt.hellip =
    ...
    (Lt.dArr =
      ...
      Lt.Downarrow =
        i(j, "\\Downarrow ", "&dArr;")),
    (Lt.diverges = Lt.uarr = Lt.uparrow = i(j, "\\uparrow ", "&uarr;")),
    (Lt.uArr = Lt.Uparrow = i(j, "\\Uparrow ", "&uArr;")),
    (Lt.to = i(Q, "\\to ", "&rarr;")),
    (Lt.rarr = Lt.rightarrow = i(j, "\\rightarrow ", "&rarr;")),
    (Lt.implies = i(Q, "\\Rightarrow ", "&rArr;")),
    (Lt.rArr = Lt.Rightarrow = i(j, "\\Rightarrow ", "&rArr;")),
    (Lt.gets = i(Q, "\\gets ", "&larr;")),
    (Lt.larr = Lt.leftarrow = i(j, "\\leftarrow ", "&larr;")),
    (Lt.impliedby = i(Q, "\\Leftarrow ", "&lArr;")),
    (Lt.lArr = Lt.Leftarrow = i(j, "\\Leftarrow ", "&lArr;")),
    (Lt.harr =
      Lt.lrarr =
      Lt.leftrightarrow =
        i(j, "\\leftrightarrow ", "&harr;")),
    (Lt.iff = i(Q, "\\Leftrightarrow ", "&hArr;")),
    (Lt.hArr =
      Lt.lrArr =
      Lt.Leftrightarrow =
        i(j, "\\Leftrightarrow ", "&hArr;")),
    (Lt.Re = Lt.Real = Lt.real = i(j, "\\Re ", "&real;")),
    (Lt.Im =
      Lt.imag =
      Lt.image =
      Lt.imagin =
      ...
      Lt.Imaginary =
        i(j, "\\Im ", "&image;")),
    (Lt.part = Lt.partial = i(j, "\\partial ", "&part;")),
    (Lt.infty = Lt.infin = Lt.infinity = i(j, "\\infty ", "&infin;")),
    (Lt.alef =
      Lt.alefsym =
      Lt.aleph =
      Lt.alephsym =
        i(j, "\\aleph ", "&alefsym;")),
    (Lt.xist = Lt.xists = Lt.exist = Lt.exists = i(j, "\\exists ", "&exist;")),
    (Lt.and = Lt.land = Lt.wedge = i(j, "\\wedge ", "&and;")),
    (Lt.or = Lt.lor = Lt.vee = i(j, "\\vee ", "&or;")),
    (Lt.o =
      Lt.O =
      Lt.empty =
      Lt.emptyset =
    ...
    (Lt.cup = Lt.union = i(Q, "\\cup ", "&cup;")),
    (Lt.cap = Lt.intersect = Lt.intersection = i(Q, "\\cap ", "&cap;")),
    (Lt.deg = Lt.degree = i(j, "^\\circ ", "&deg;")),
    (Lt.ang = Lt.angle = i(j, "\\angle ", "&ang;")),
    (A = jt(j, function (t, e) {
      t.createLeftOf = function (t) {
        t.options.autoSubscriptNumerals &&
        t.parent !== t.parent.parent.sub &&
        ((t[Qt] instanceof R && t[Qt].isItalic !== !1) ||
          (t[Qt] instanceof rt &&
            t[Qt][Qt] instanceof R &&
            t[Qt][Qt].isItalic !== !1))
          ? (Lt._().createLeftOf(t),
            e.createLeftOf.call(this, t),
    ...
    (R = jt(k, function (t, e) {
      (t.init = function (t, n) {
        ...
        (t.text = function () {
          ...
          return (
            !this[Qt] ||
              this[Qt] instanceof R ||
              this[Qt] instanceof Q ||
              (t = "*" + t),
            !this[Tt] ||
    ...
    (Mt.p.autoCommands = { _maxLength: 0 }),
    (Bt.autoCommands = function (t) {
      var e, n, i, s, r;
      if (!/^[a-z]+(?: [a-z]+)*$/i.test(t))
      ...
      for (e = t.split(" "), n = {}, i = 0, s = 0; s < e.length; s += 1) {
        ...
        if (Lt[r] === F) throw '"' + r + '" is a built-in operator name';
        (n[r] = 1), (i = yt(i, r.length));
      }
      ...
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          var n,
            ...
            o = r._maxLength;
          if (o > 0) {
            for (n = this.letter, i = t[Qt], s = 1; i instanceof I && o > s; )
              (n = i.letter + n), (i = i[Qt]), (s += 1);
            for (; n.length; ) {
              if (r.hasOwnProperty(n)) {
                for (s = 2, i = t[Qt]; s < n.length; s += 1, i = i[Qt]);
                return (
                  _t(i, t[Qt]).remove(),
                  (t[Qt] = i[Qt]),
                  Lt[n](n).createLeftOf(t)
                );
              }
              n = n.slice(1);
            }
        ...
        (t.finalizeTree =
          ...
          t.siblingCreated =
            function (t, e) {
              (e !== Qt && this[Tt] instanceof I) || this.autoUnItalicize(t);
            }),
        (t.autoUnItalicize = function (t) {
          ...
          if (0 !== p._maxLength) {
            for (e = this.letter, i = this[Qt]; i instanceof I; i = i[Qt])
              e = i.letter + e;
            for (s = this[Tt]; s instanceof I; s = s[Tt]) e += s.letter;
            _t(
              i[Tt] || this.parent.ends[Qt],
              s[Qt] || this.parent.ends[Tt]
            ).each(function (t) {
              t.italicize(!0).jQ.removeClass("mq-first mq-last"),
                (t.ctrlSeq = t.letter);
            });
            t: for (
              r = 0, o = i[Tt] || this.parent.ends[Qt];
              r < e.length;
              r += 1, o = o[Tt]
            )
              for (a = xt(p._maxLength, e.length - r); a > 0; a -= 1)
                if (((l = e.slice(r, r + a)), p.hasOwnProperty(l))) {
                  for (c = 0, u = o; a > c; c += 1, u = u[Tt])
                    u.italicize(!1), (h = u);
                  (f = z.hasOwnProperty(l)),
                    (o.ctrlSeq = (f ? "\\" : "\\operatorname{") + o.ctrlSeq),
                    (h.ctrlSeq += f ? " " : "}"),
                    M.hasOwnProperty(l) && h[Qt][Qt][Qt].jQ.addClass("mq-last"),
                    n(o[Qt]) && o.jQ.addClass("mq-first"),
                    n(h[Tt]) && h.jQ.addClass("mq-last"),
                    (r += a - 1),
                    (o = h);
                  continue t;
                }
    ...
    (z = {}),
    (M = { limsup: 1, liminf: 1, projlim: 1, injlim: 1 }),
    (B = Mt.p.autoOperatorNames = { _maxLength: 9 }),
    (function () {
      var t,
        e,
        n,
      ...
      for (t = 0; t < s.length; t += 1) z[s[t]] = B[s[t]] = 1;
      for (
        e =
    ...
    (Bt.autoOperatorNames = function (t) {
      var e, n, i, s, r;
      if (!/^[a-z]+(?: [a-z]+)*$/i.test(t))
        throw '"' + t + '" not a space-delimited list of only letters';
      for (e = t.split(" "), n = {}, i = 0, s = 0; s < e.length; s += 1) {
      ...
      (t.init = function (t) {
        ...
        (t.parser = function () {
          ...
          for (t = 0; t < e.length; t += 1)
            I(e.charAt(t)).adopt(n, n.ends[Tt], 0);
          return w.succeed(n.children());
        });
    }));
  for ($ in B) B.hasOwnProperty($) && (Lt[$] = F);
  (Lt.operatorname = jt(O, function (e) {
    (e.createLeftOf = t),
      (e.numBlocks = function () {
        return 1;
      }),
    ...
    (Lt[" "] = Lt.space = i(j, "\\ ", "&nbsp;")),
    (Lt["'"] = Lt.prime = i(j, "'", "&prime;")),
    (Lt.backslash = i(j, "\\backslash ", "\\")),
    Et["\\"] || (Et["\\"] = Lt.backslash),
    (Lt.$ = i(j, "\\$", "$")),
    (N = jt(k, function (t, e) {
      t.init = function (t, n) {
    ...
    (Lt.phi = i(R, "\\phi ", "&#981;")),
    (Lt.phiv = Lt.varphi = i(R, "\\varphi ", "&phi;")),
    (Lt.epsilon = i(R, "\\epsilon ", "&#1013;")),
    (Lt.epsiv = Lt.varepsilon = i(R, "\\varepsilon ", "&epsilon;")),
    (Lt.piv = Lt.varpi = i(R, "\\varpi ", "&piv;")),
    (Lt.sigmaf = Lt.sigmav = Lt.varsigma = i(R, "\\varsigma ", "&sigmaf;")),
    (Lt.thetav = Lt.vartheta = Lt.thetasym = i(R, "\\vartheta ", "&thetasym;")),
    (Lt.upsilon = Lt.upsi = i(R, "\\upsilon ", "&upsilon;")),
    (Lt.gammad = Lt.Gammad = Lt.digamma = i(R, "\\digamma ", "&#989;")),
    (Lt.kappav = Lt.varkappa = i(R, "\\varkappa ", "&#1008;")),
    (Lt.rhov = Lt.varrho = i(R, "\\varrho ", "&#1009;")),
    (Lt.pi = Lt["π"] = i(N, "\\pi ", "&pi;")),
    (Lt.lambda = i(N, "\\lambda ", "&lambda;")),
    (Lt.Upsilon =
      Lt.Upsi =
      Lt.upsih =
      Lt.Upsih =
    ...
    (P = jt(O, function (t) {
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          ...
          e.children().adopt(t.parent, t[Qt], t[Tt]),
            (t[Qt] = e.ends[Tt]),
            e.jQize().insertBefore(t.jQ),
            e.finalizeInsert(t.options, t),
            e.ends[Tt][Tt].siblingCreated &&
              e.ends[Tt][Tt].siblingCreated(t.options, Qt),
            e.ends[Qt][Qt].siblingCreated &&
              e.ends[Qt][Qt].siblingCreated(t.options, Tt),
    ...
    (Lt["+"] = i(U, "+", "+")),
    (Lt["–"] = Lt["-"] = i(U, "-", "&minus;")),
    (Lt["±"] = Lt.pm = Lt.plusmn = Lt.plusminus = i(U, "\\pm ", "&plusmn;")),
    (Lt.mp = Lt.mnplus = Lt.minusplus = i(U, "\\mp ", "&#8723;")),
    (Et["*"] = Lt.sdot = Lt.cdot = i(Q, "\\cdot ", "&middot;")),
    (W = jt(Q, function (t, e) {
      (t.init = function (t, n) {
    ...
    (Lt["<"] = Lt.lt = i(W, H, !0)),
    (Lt[">"] = Lt.gt = i(W, G, !0)),
    (Lt["≤"] = Lt.le = Lt.leq = i(W, H, !1)),
    (Lt["≥"] = Lt.ge = Lt.geq = i(W, G, !1)),
    (K = jt(Q, function (t, e) {
      (t.init = function () {
        e.init.call(this, "=", "=");
      }),
        (t.createLeftOf = function (t) {
          return t[Qt] instanceof W && t[Qt].strict
            ? (t[Qt].swap(!1), void t[Qt].bubble("reflow"))
            : void e.createLeftOf.apply(this, arguments);
        });
    })),
    (Lt["="] = K),
    (Lt.times = i(Q, "\\times ", "&times;", "[x]")),
    (Lt["÷"] =
      Lt.div =
      Lt.divide =
      Lt.divides =
  ...
  tt
    ...
    (nt = jt(O, function (t, e) {
      t.init = function (t, n, i) {
        e.init.call(this, t, "<" + n + " " + i + ">&0</" + n + ">");
      };
    })),
    (Lt.mathrm = i(nt, "\\mathrm", "span", 'class="mq-roman mq-font"')),
    (Lt.mathit = i(nt, "\\mathit", "i", 'class="mq-font"')),
    (Lt.mathbf = i(nt, "\\mathbf", "b", 'class="mq-font"')),
    (Lt.mathsf = i(nt, "\\mathsf", "span", 'class="mq-sans-serif mq-font"')),
    (Lt.mathtt = i(nt, "\\mathtt", "span", 'class="mq-monospace mq-font"')),
    (Lt.underline = i(
      nt,
      "\\underline",
      "span",
    ...
    (rt = jt(O, function (t, e) {
      (t.ctrlSeq = "_{...}^{...}"),
        (t.createLeftOf = function (t) {
          return t[Qt] || !t.options.supSubsRequireOperand
            ? e.createLeftOf.apply(this, arguments)
            : void 0;
        }),
        (t.contactWeld = function (t) {
          var e, n, i, s, r, o;
          for (e = Qt; e; e = e === Qt ? Tt : !1)
                    ...
                    (s
                      ? i.isEmpty()
                        ...
                        : (i.jQ.children().insAtDirEnd(-e, s.jQ),
                          (r = i.children().disown()),
                          (o = Dt(s, r.ends[Tt], s.ends[Qt])),
                          e === Qt
                            ? r.adopt(s, s.ends[Tt], 0)
                            : r.adopt(s, 0, s.ends[Qt]))
        ...
        (Mt.p.charsThatBreakOutOfSupSub = ""),
        ...
        (t.deleteTowards = function (t, n) {
          if (n.options.autoSubscriptNumerals && this.sub) {
            ...
            i instanceof k
              ...
              this.sub.isEmpty() &&
                (this.sub.deleteOutOf(Qt, n.insAtLeftEnd(this.sub)),
            ...
            (function (t, e, n, i) {
              t[e].deleteOutOf = function (s, r) {
                ...
                (t.supsub = n),
                  ...
                  "sub" === e &&
                    Ct(t.jQ.addClass("mq-sup-only")[0].lastChild).remove(),
                  this.remove();
              };
            })(
              this,
    ...
    (Lt.subscript = Lt._ =
      jt(rt, function (t, e) {
        (t.supsub = "sub"),
          ...
          (t.textTemplate = ["_"]),
          (t.finalizeTree = function () {
            (this.downInto = this.sub = this.ends[Qt]),
              (this.sub.upOutOf = f),
      ...
      Lt["^"] =
        jt(rt, function (t, e) {
          (t.supsub = "sup"),
            ...
            (t.textTemplate = ["**"]),
            (t.finalizeTree = function () {
              (this.upInto = this.sup = this.ends[Tt]),
                (this.sup.downOutOf = f),
                e.finalizeTree.call(this);
            });
        })),
    (ot = jt(O, function (t, e) {
      (t.init = function (t, e) {
        var n =
        ...
        (t.parser = function () {
          var t,
            ...
            r = this,
            o = (r.blocks = [T(), T()]);
          for (t = 0; t < o.length; t += 1) o[t].adopt(r, r.ends[Tt], 0);
          return n
            .then(e("_").or(e("^")))
            .then(function (t) {
              var e = o["_" === t ? 0 : 1];
              return s.then(function (t) {
                return t.children().adopt(e, e.ends[Tt], 0), i(r);
              });
            })
            .many()
            .result(r);
        ...
        (t.finalizeTree = function () {
          (this.downInto = this.ends[Qt]),
            (this.upInto = this.ends[Tt]),
            (this.ends[Qt].upOutOf = this.ends[Tt]),
            (this.ends[Tt].downOutOf = this.ends[Qt]);
        });
    })),
    (Lt["∑"] = Lt.sum = Lt.summation = i(ot, "\\sum ", "&sum;")),
    (Lt["∏"] = Lt.prod = Lt.product = i(ot, "\\prod ", "&prod;")),
    (Lt.coprod = Lt.coproduct = i(ot, "\\coprod ", "&#8720;")),
    (at =
      Lt.frac =
      Lt.dfrac =
      Lt.cfrac =
      Lt.fraction =
        jt(O, function (t, e) {
          (t.ctrlSeq = "\\frac"),
            ...
            (t.textTemplate = ["(", "/", ")"]),
            (t.finalizeTree = function () {
              (this.upInto = this.ends[Tt].upOutOf = this.ends[Qt]),
                (this.downInto = this.ends[Qt].downOutOf = this.ends[Tt]);
            });
        })),
    (lt =
      Lt.over =
          ...
          e.createLeftOf = function (e) {
            if (!this.replacedFragment) {
              ...
              i instanceof ot &&
                ...
                ((i = i[Tt]),
                i[Tt] instanceof rt &&
                  i[Tt].ctrlSeq != i.ctrlSeq &&
                  (i = i[Tt])),
                i !== e[Qt] &&
                  (this.replaces(_t(i[Tt] || e.parent.ends[Qt], e[Qt])),
                  (e[Qt] = i));
            }
    ...
    (ft = jt(jt(O, p), function (e, n) {
      (e.init = function (t, e, i, s, r) {
        n.init.call(this, "\\left" + s, m, [e, i]),
          (this.side = t),
          (this.sides = {}),
          (this.sides[Qt] = { ch: e, ctrlSeq: s }),
          (this.sides[Tt] = { ch: i, ctrlSeq: r });
      }),
        (e.numBlocks = function () {
          return 1;
        }),
        ...
        (e.oppBrack = function (t, e, n) {
          return (
            ...
            (!t.restrictMismatchedBrackets ||
              ...
              { "(": "]", "[": ")" }[this.sides[Qt].ch] === e.sides[Tt].ch) &&
            e
          );
        }),
            ...
            i
              ...
              : ((i = this),
                ...
                i.replacedFragment
                  ? (i.side = 0)
                  : t[-s] &&
                    (i.replaces(_t(t[-s], t.parent.ends[-s], s)), (t[-s] = 0)),
                n.createLeftOf.call(i, t)),
            s === Qt ? t.insAtLeftEnd(i.ends[Qt]) : t.insRightOf(i);
        }),
        (e.placeCursor = t),
        (e.unwrap = function () {
          this.ends[Qt].children()
            .disown()
            .adopt(this.parent, this, this[Tt])
        ...
        (e.deleteSide = function (t, e, n) {
          ...
          if (
            ...
            (s = !this.side),
            (this.side = -t),
            this.oppBrack(i, this.ends[Qt].ends[this.side], t))
          )
            this.closeOpposing(this.ends[Qt].ends[this.side]),
              (r = this.ends[Qt].ends[t]),
              this.unwrap(),
            ...
            a
              ? ((r = this.ends[Qt].ends[t]),
                _t(a, l, -t)
                  .disown()
                  .withDirAdopt(-t, this.ends[Qt], r, 0)
                  .jQ.insAtDirEnd(t, this.ends[Qt].jQ.removeClass("mq-empty")),
                r.siblingCreated && r.siblingCreated(n.options, t),
                n.insDirOf(-t, a))
              : e
              ? n.insDirOf(t, this)
              : n.insAtDirEnd(t, this.ends[Qt]);
          }
        }),
        (e.deleteTowards = function (t, e) {
        ...
        (e.finalizeTree = function () {
          (this.ends[Qt].deleteOutOf = function (t, e) {
    ...
    d("["),
    d("{", "\\{"),
    (Lt.langle = i(ft, Qt, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
    (Lt.rangle = i(ft, Tt, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
    (Et["|"] = i(ft, Qt, "|", "|", "|", "|")),
    (Lt.left = jt(O, function (t) {
      t.parser = function () {
        var t = w.regex,
          e = w.string,
    ...
    (Lt.editable = Lt.MathQuillMathField =
      jt(O, function (t, e) {
        (t.ctrlSeq = "\\MathQuillMathField"),
          ...
          (t.finalizeTree = function () {
            var t = It(this.ends[Qt], this.jQ, Mt());
          ...
          (t.registerInnerField = function (t, e) {
            t.push((t[this.name] = e(this.ends[Qt].controller)));
          }),
          (t.latex = function () {
            return this.ends[Qt].latex();
          }),
          (t.text = function () {
            return this.ends[Qt].text();
          });
      })),
    (gt = c(1));
  for (bt in gt)
