...
$.fn.percircle = function (options) {
  ...
  return this.each(function () {
    ...
    // apply options
    if (typeof percircle.attr("data-animate") !== "undefined")
      localOptions.animate = percircle.attr("data-animate") == "true";
    if (localOptions.animate) percircle.addClass("animate");
    if (typeof percircle.attr("data-animateOnView") !== "undefined")
      localOptions.animateOnView =
        percircle.attr("data-animateOnView") == "true";
    ...
    var perclock =
      percircle.attr("data-perclock") || localOptions.perclock || 0;
    var perdown = percircle.attr("data-perdown") || localOptions.perdown || 0;

    var animateOnView =
      localOptions.animate && localOptions.animateOnView && !inViewport(this);
    ...
    if (percent || localOptions.displayTextAtZero) {
      ...
      var text =
        percircle.attr("data-text") || localOptions.text || percent + "%";
