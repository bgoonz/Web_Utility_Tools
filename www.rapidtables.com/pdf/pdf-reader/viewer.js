      ...
      function getViewerConfiguration() {
        return {
          ...
          toolbar: {
            ...
            openFile2: document.getElementById("openFile2"),
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function webViewerInitialized() {
        ...
        appConfig.mainContainer.addEventListener("dragover", function (evt) {
          ...
          document.getElementById("open").classList.add("draghover");
        });
        appConfig.mainContainer.addEventListener("dragleave", function (evt) {
          evt.preventDefault();
          //evt.dataTransfer.dropEffect = 'move';
          document.getElementById("open").classList.remove("draghover");
        });
        appConfig.mainContainer.addEventListener("dragend", function (evt) {
          evt.preventDefault();
          //evt.dataTransfer.dropEffect = 'move';
          document.getElementById("open").classList.remove("draghover");
        });
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var defaultOptions = {
        ...
        workerSrc: {
          ...
          value:
            "https://cdn.jsdelivr.net/npm/pdfjs-dist@2.2.2/build/pdf.worker.js",
          kind: OptionKind.WORKER,
        },
      };
      {
          ...
          _createClass(Toolbar, [
            ...
            },
            {
              ...
              value: function _bindListeners() {
                ...
                //!!!
                items.openFile2.addEventListener("click", function () {
                  eventBus.dispatch("openfile", {
                    source: self,
                  });
                });
